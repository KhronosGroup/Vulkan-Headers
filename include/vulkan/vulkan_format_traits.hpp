...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  {
    static std::vector<Format> depthFormats = { Format::eD16Unorm, Format::eX8D24UnormPack32, Format::eD32Sfloat, Format::eD16UnormS8Uint, Format::eD24UnormS8Uint, Format::eD32SfloatS8Uint };
    return depthFormats;
  }
